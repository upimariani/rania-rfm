...
class cCheckout extends CI_Controller
{
	...
	{
		$this->load->view('Pelanggan/Layout/header');
		$this->load->view('Pelanggan/vAlamatLain');
		// $this->load->view('Pelanggan/Layout/footer');
	}
	public function order()
	{
		$data = array(
			...
			'alamat_pengiriman' => $this->input->post('alamat') . ' Expedisi.' . $this->input->post('expedisi') . ' ' . $this->input->post('paket'),
			'stat_transaksi' => '0'
		);
